...
| サブシステム         | 技術スタック                               | 目的                        |
| -------------------- | ------------------------------------------ | --------------------------- |
| **CMS バックエンド** | Spring Boot 3.4.x + Java 17                | コンテンツ CRUD・API 提供   |
...
| カテゴリ             | 技術            | バージョン | 用途                   |
| -------------------- | --------------- | ---------- | ---------------------- |
| **フレームワーク**   | Spring Boot     | 3.4.x      | アプリケーション基盤   |
...
| 項目                   | 選択                                 | 理由                               |
| ---------------------- | ------------------------------------ | ---------------------------------- |
| **バックエンド**       | Spring Boot 3.4.x + Java 17          | エンタープライズ実績、長期サポート |
